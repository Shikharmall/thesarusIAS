          ...
          {question?.options.map((option, index) => {
            ...
            return (
              <button
                ...
                className={`flex items-center px-4 py-4 rounded-xl min-h-[56px] text-left transition-colors border ${
                  isSelected
              ...
              >
                {/* Radio Circle */}
                <div
                  className={`w-6 h-6 mr-4 flex items-center justify-center rounded-full border ${
