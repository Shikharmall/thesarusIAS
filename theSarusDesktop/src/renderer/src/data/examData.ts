import { Question, Section, ExamData } from "@renderer/utils/types/testseries"
...
<p>Which one of the following is correct in respect of the above statements?</p>`,
    ...
    },
    {
        ...
        options: [
            ...
            { label: "<p>(d) The International Bank for Reconstruction and Development (IBRD)</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the statements given above is/are correct?</p>`,
        options: [
            ...
            { label: "<p>(c) II only</p>", isCorrect: false },
...
<p>Which of the statements given above is/are correct?</p>`,
        options: [
            ...
            { label: "<p>(c) II and III only</p>", isCorrect: false },
            { label: "<p>(d) I, II and III</p>", isCorrect: false },
        ],
        solution: "",
    },
...
<p>Which of the statements given above is/are correct?</p>`,
        options: [
            ...
            { label: "<p>(b) II only</p>", isCorrect: false },
            { label: "<p>(c) I and III</p>", isCorrect: false },
            { label: "<p>(d) None of the above statements is correct</p>", isCorrect: false },
        ],
        solution: "",
    },
...
<p>How many of the above were parts of the Non-Cooperation Programme?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: "<p>(a) a water bag made of leather pulled over a pulley</p>", isCorrect: false },
    ...
    },
    {
        ...
        options: [
            ...
            { label: "<p>(d) Simhavarman</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            ...
            { label: "<p>(d) Skandagupta</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            ...
            { label: "<p>(d) Vishnuvardhana (Hoysala)</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>How many of the pairs given above are correctly matched?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: "<p>(a) Delhi</p>", isCorrect: false },
    ...
    },
    {
        ...
        options: [
            { label: "<p>(a) village-level administration</p>", isCorrect: false },
...
<p>Select the correct answer using the code given below:</p>`,
        options: [
            ...
            { label: "<p>(c) I, III, IV and V</p>", isCorrect: false },
...
<p>Which one of the following is correct in respect of the above statements?</p>`,
        options: [
            ...
            { label: "<p>(c) Statement I is correct but Statement II is incorrect</p>", isCorrect: false },
...
<p>How many of the above are members of the North Atlantic Treaty Organization?</p>`,
        options: [
            { label: "<p>(a) Only three</p>", isCorrect: false },
...
<p>Select the correct answer using the code given below.</p>`,
        options: [
            { label: "<p>(a) II and IV only</p>", isCorrect: false },
...
<p>How many of the pairs given above are correctly matched?</p>`,
    ...
    },
    {
        ...
        options: [
            ...
            { label: "<p>(b) Silver nitrate and potassium iodide</p>", isCorrect: false },
...
<p>Which one of the following is correct in respect of the above statements?</p>`,
    ...
    },
    {
        ...
        options: [
            ...
            { label: "<p>(d) The Food and Agriculture Organization</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<ol style="list-style-type: upper-roman;">
  ...
  <li>Primary deficit is ₹4,000 crores.</li>
    ...
    },
    {
        ...
        options: [
            { label: "<p>(a) India to Central Asia to Europe via Iran</p>", isCorrect: false },
...
<p>What is the gross primary deficit?</p>`,
        options: [
            { label: "<p>(a) ₹48,500 crores</p>", isCorrect: false },
...
<p>How many of the above are considered as alternative powertrain vehicles?</p>`,
        options: [
            { label: `<p>Only one</p>`, isCorrect: false },
            { label: `<p>Only two</p>`, isCorrect: false },
            { label: `<p>All the three</p>`, isCorrect: true },
...
<p>How many of the statements given above are correct?</p>`,
        options: [
            { label: `<p>Only one</p>`, isCorrect: false },
            { label: `<p>Only two</p>`, isCorrect: true },
            { label: `<p>All the three</p>`, isCorrect: false },
            { label: `<p>None</p>`, isCorrect: false },
        ],
        solution: "",
    },
...
<p>How many of the above usually make up battery cathodes?</p>`,
        options: [
            { label: `<p>Only one</p>`, isCorrect: false },
            { label: `<p>Only two</p>`, isCorrect: false },
            { label: `<p>Only three</p>`, isCorrect: true },
            { label: `<p>All the four</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Coal gasification technology can be used in the production of how many of them?</p>`,
        options: [
            { label: `<p>Only one</p>`, isCorrect: true },
            { label: `<p>Only two</p>`, isCorrect: false },
            { label: `<p>All the three</p>`, isCorrect: false },
            { label: `<p>None</p>`, isCorrect: false },
        ],
    ...
    },
    {
        ...
        question: `<p>What is the common characteristic of the chemical substances generally known as CL-20, HMX and LLM-105, which are sometimes talked about in media?</p>`,
        options: [
            { label: `<p>These are alternatives to hydro-fluorocarbon refrigerants</p>`, isCorrect: false },
            { label: `<p>These are explosives in military weapons</p>`, isCorrect: true },
            { label: `<p>These are high-energy fuels for cruise missiles</p>`, isCorrect: false },
            { label: `<p>These are fuels for rocket propulsion</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the statements given above are correct?</p>`,
        options: [
            { label: `<p>I and II only</p>`, isCorrect: false },
            { label: `<p>II and III only</p>`, isCorrect: false },
            { label: `<p>I and III only</p>`, isCorrect: true },
            { label: `<p>I, II and III</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the statements given above are correct?</p>`,
        options: [
            { label: `<p>I and II only</p>`, isCorrect: true },
            { label: `<p>II and III only</p>`, isCorrect: false },
            { label: `<p>I and III only</p>`, isCorrect: false },
            { label: `<p>I, II and III</p>`, isCorrect: false },
        ],
        solution: "",
    },
...
<p>Which one of the following is correct in respect of the above statements?</p>`,
        options: [
            { label: `<p>Both Statement II and Statement III are correct and both of them explain Statement I</p>`, isCorrect: true },
...
<p>Which one of the following statements best reflects the central idea conveyed by the passage?</p>`,
        options: [
            { label: `<p>India does not have enough resources for promoting quality education in its universities.</p>`, isCorrect: false },
            { label: `<p>The institutions of higher learning in the country should not be under the control of the Government.</p>`, isCorrect: false },
            { label: `<p>Classroom approach to higher education should be done away with.</p>`, isCorrect: false },
            { label: `<p>Classroom needs to be reimagined and teaching needs to be re-invented.</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
        options: [
            { label: `<p>I only</p>`, isCorrect: true },
            { label: `<p>II only</p>`, isCorrect: false },
            { label: `<p>Both I and II</p>`, isCorrect: false },
            { label: `<p>Neither I nor II</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following statements best reflects the crux of the passage?</p>`,
        options: [
            { label: `<p>There is an urgent need for a public policy to promote the consumption of cereal-based foods in wealthier societies.</p>`, isCorrect: false },
            { label: `<p>Animal-based food is far less efficient than grain/plant-based food in terms of production and utilization.</p>`, isCorrect: true },
            { label: `<p>Plant-based protein should replace the animal-based protein in our daily diets.</p>`, isCorrect: false },
            { label: `<p>Inequality in food production and consumption is inevitable in any fast changing society.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
        options: [
            { label: `<p>I only</p>`, isCorrect: true },
            { label: `<p>II only</p>`, isCorrect: true },
            { label: `<p>Both I and II</p>`, isCorrect: false },
            { label: `<p>Neither I nor II</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>3</p>`, isCorrect: true },
            { label: `<p>4</p>`, isCorrect: false },
            { label: `<p>5</p>`, isCorrect: false },
            { label: `<p>7</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>18</p>`, isCorrect: false },
            { label: `<p>12</p>`, isCorrect: true },
            { label: `<p>9</p>`, isCorrect: false },
            { label: `<p>6</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>12</p>`, isCorrect: false },
            { label: `<p>13</p>`, isCorrect: false },
            { label: `<p>14</p>`, isCorrect: true },
            { label: `<p>15</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>60 _ 15 _ 3 _ 20 _ 4 = 20</p>`,
        options: [
            { label: `<p>SPRQ</p>`, isCorrect: false },
            { label: `<p>QRPS</p>`, isCorrect: false },
            { label: `<p>QRSP</p>`, isCorrect: true },
            { label: `<p>SPQR</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>15 m</p>`, isCorrect: false },
            { label: `<p>18 m</p>`, isCorrect: true },
            { label: `<p>20 m</p>`, isCorrect: false },
            { label: `<p>24 m</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>8</p>`, isCorrect: false },
            { label: `<p>9</p>`, isCorrect: false },
            { label: `<p>10</p>`, isCorrect: true },
            { label: `<p>11</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the critical message conveyed by the author of the passage?</strong></p>`,
        options: [
            { label: `<p>Conservation of biodiversity is not an issue to be worried about when some people depend on ecosystems for their livelihoods.</p>`, isCorrect: false },
            { label: `<p>Commercial exploitation of forests goes against the fundamental rights of the people dependent on forests for food and shelter.</p>`, isCorrect: false },
            { label: `<p>Sustenance of livelihood and degradation of ecosystem while being together exacerbate one another, leading to conflicts and imbalance.</p>`, isCorrect: true },
            { label: `<p>Commercial exploitation of ecosystems should be completely stopped.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
        options: [
            { label: `<p>I only</p>`, isCorrect: false },
            { label: `<p>II only</p>`, isCorrect: false },
            { label: `<p>Both I and II</p>`, isCorrect: false },
            { label: `<p>Neither I nor II</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the central idea of the passage?</strong></p>`,
        options: [
            { label: `<p>Economies of scale is essential for transition to green growth.</p>`, isCorrect: false },
            { label: `<p>Modern technological progress is intensely linked to path-dependent innovations.</p>`, isCorrect: false },
            { label: `<p>Countries with large economies are in a better position to adopt green technologies.</p>`, isCorrect: false },
            { label: `<p>Timing plays a crucial role in the case of green technology development.</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: `<p>4</p>`, isCorrect: false },
            { label: `<p>5</p>`, isCorrect: true },
            { label: `<p>6</p>`, isCorrect: false },
            { label: `<p>More than 6</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>None</p>`, isCorrect: false },
            { label: `<p>One</p>`, isCorrect: false },
            { label: `<p>Three</p>`, isCorrect: true },
            { label: `<p>More than three</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>January, January, December, October, X, March, October, Y, September</p>`,
        options: [
            { label: `<p>July, May</p>`, isCorrect: false },
            { label: `<p>July, April</p>`, isCorrect: false },
            { label: `<p>June, May</p>`, isCorrect: true },
            { label: `<p>June, April</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>72</p>`, isCorrect: false },
            { label: `<p>144</p>`, isCorrect: true },
            { label: `<p>216</p>`, isCorrect: false },
            { label: `<p>Cannot be determined</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>p(10000-k²)² = q × 108</p>`, isCorrect: false },
            { label: `<p>p(10000-k²)² = q × 104</p>`, isCorrect: false },
            { label: `<p>p(10000-k²)  = q × 104</p>`, isCorrect: false },
            { label: `<p>p(10000-k²)  = q × 108</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the corollary to the above passage?</strong></p>`,
        options: [
            { label: `<p>The benefit of economic reforms percolates down more slowly to the agriculture sector than in other sectors of the economy.</p>`, isCorrect: true },
            { label: `<p>For India, the green revolution was not as useful as it was expected to be.</p>`, isCorrect: false },
            { label: `<p>India lagged behind other countries in adapting mechanized and modern farming.</p>`, isCorrect: false },
            { label: `<p>Rural-to-urban migration resulted in the stagnant agriculture sector.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the most logical and rational message conveyed by the author of the passage?</strong></p>`,
        options: [
            { label: `<p>We need to free the handloom industry from the limited narrative linked to preserving cultural heritage.</p>`, isCorrect: true },
            { label: `<p>Continued State support to the handloom industry ensures the preservation of some of our glorious art forms and old traditions.</p>`, isCorrect: false },
            { label: `<p>Household units of the handloom sector should be modernized and made an economically viable organized industry.</p>`, isCorrect: false },
            { label: `<p>Handloom products need to be converted to machine-made designer products so as to make them more popular.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: `<p>20</p>`, isCorrect: false },
            { label: `<p>21</p>`, isCorrect: false },
            { label: `<p>22</p>`, isCorrect: true },
            { label: `<p>23</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>6</p>`, isCorrect: false },
            { label: `<p>15/2</p>`, isCorrect: true },
            { label: `<p>-15/2</p>`, isCorrect: false },
            { label: `<p>None of the above</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
    ...
    },
    {
        ...
        options: [
            { label: `<p>6</p>`, isCorrect: false },
            { label: `<p>7</p>`, isCorrect: false },
            { label: `<p>8</p>`, isCorrect: true },
            { label: `<p>More than 8</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>2</p>`, isCorrect: false },
            { label: `<p>3</p>`, isCorrect: true },
            { label: `<p>4</p>`, isCorrect: false },
            { label: `<p>More than 4</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>B, C, B, C, A</p>`, isCorrect: false },
            { label: `<p>A, C, B, C, A</p>`, isCorrect: false },
            { label: `<p>B, C, B, A, C</p>`, isCorrect: true },
            { label: `<p>C, B, B, A, C</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the central idea conveyed by the passage?</strong></p>`,
        options: [
            { label: `<p>Global climate change adversely affects the productivity of crops.</p>`, isCorrect: false },
            { label: `<p>Our total dependence on genetically honed crops entails possible food insecurity.</p>`, isCorrect: true },
            { label: `<p>Our food security should not depend on agricultural productivity alone.</p>`, isCorrect: false },
            { label: `<p>Genetically honed crops should be replaced with their wild varieties in our present cultivation practices.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
        options: [
            { label: `<p>I only</p>`, isCorrect: false },
            { label: `<p>II only</p>`, isCorrect: false },
            { label: `<p>Both I and II</p>`, isCorrect: true },
            { label: `<p>Neither I nor II</p>`, isCorrect: false },
        ],
        solution: "",
    },
...
<p><strong>Which one of the following statements best reflects the critical message conveyed by the author of the passage?</strong></p>`,
        options: [
            { label: `<p>Without opposition parties, the administration in a democracy gets to become more responsible.</p>`, isCorrect: false },
            { label: `<p>Democracy needs to have revolutionaries in opposition to keep the government alert.</p>`, isCorrect: false },
            { label: `<p>Rulers in a democracy need the support of opposition for their political survival.</p>`, isCorrect: false },
            { label: `<p>In a democracy, the opposition is indispensable for the balance of political power and good governance.</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
...
<li>P is S's son.</li>
        ...
        options: [
            { label: `<p>Only two</p>`, isCorrect: false },
            { label: `<p>Only three</p>`, isCorrect: true },
            { label: `<p>Only four</p>`, isCorrect: false },
            { label: `<p>Only five</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>399000</p>`, isCorrect: false },
            { label: `<p>420000</p>`, isCorrect: true },
            { label: `<p>440000</p>`, isCorrect: false },
            { label: `<p>630000</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>54321</p>`, isCorrect: false },
            { label: `<p>81913</p>`, isCorrect: false },
            { label: `<p>71913</p>`, isCorrect: true },
            { label: `<p>71813</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>3</p>`, isCorrect: false },
            { label: `<p>4</p>`, isCorrect: true },
            { label: `<p>5</p>`, isCorrect: false },
            { label: `<p>6</p>`, isCorrect: false },
        ],
        solution: "",
    ...
    },
    {
        ...
        options: [
            { label: `<p>26</p>`, isCorrect: false },
            { label: `<p>27</p>`, isCorrect: false },
            { label: `<p>29</p>`, isCorrect: true },
            { label: `<p>30</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the most logical, rational and crucial message conveyed by the passage?</strong></p>`,
        options: [
            { label: `<p>We must use WPI exclusively in measuring price rise and CPI should be done away with.</p>`, isCorrect: false },
            { label: `<p>The present calculation of inflation rate does not correctly measure price rise of individual item/commodity.</p>`, isCorrect: false },
            { label: `<p>Inflation data under-presents services in the consumption basket.</p>`, isCorrect: false },
            { label: `<p>Knowledge of inflation rate is not really of any use to anybody in the country.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the crux of the passage?</strong></p>`,
        options: [
            { label: `<p>Trustworthiness cannot be expected in entrepreneurship.</p>`, isCorrect: false },
            { label: `<p>Trustworthy people are the most vulnerable people.</p>`, isCorrect: false },
            { label: `<p>No economic activity is possible without being exposed to betrayal.</p>`, isCorrect: false },
            { label: `<p>Trust is important though it entails risk.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct in respect of the above question and the Statements?</p>`,
        options: [
            { label: `<p>The Question can be answered by using one of the Statements alone, but cannot be answered using the other statement alone.</p>`, isCorrect: false },
            { label: `<p>The Question can be answered by using either Statement alone.</p>`, isCorrect: false },
            { label: `<p>The Question can be answered by using both the Statements together, but cannot be answered using either Statement alone.</p>`, isCorrect: false },
            { label: `<p>The Question cannot be answered even using any of the Statements.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct in respect of the above question and the Statements?</p>`,
        options: [
            ...
            { label: `<p>The Question can be answered by using either Statement alone.</p>`, isCorrect: false },
            { label: `<p>The Question can be answered by using both the Statements together, but cannot be answered using either Statement alone.</p>`, isCorrect: false },
            { label: `<p>The Question can be answered even without using any of the Statements.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct?</p>`,
        options: [
            { label: `<p>Value-I < Value-II < Value-III</p>`, isCorrect: false },
            { label: `<p>Value-III < Value-II < Value-I</p>`, isCorrect: false },
            { label: `<p>Value-I < Value-III < Value-II</p>`, isCorrect: false },
            { label: `<p>Cannot be determined due insufficient data</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct?</p>`,
        options: [
            { label: `<p>Value-I < Value-II</p>`, isCorrect: false },
            { label: `<p>Value-II < Value-I</p>`, isCorrect: false },
            { label: `<p>Value-I = Value-II</p>`, isCorrect: false },
            { label: `<p>Cannot be determined due to insufficient data</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: `<p>k</p>`, isCorrect: false },
            { label: `<p>k-1</p>`, isCorrect: false },
            { label: `<p>k+1</p>`, isCorrect: false },
            { label: `<p>k/2</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Select the correct answer using the code given below:</p>`,
    ...
    },
    {
        ...
        options: [
            { label: `<p>There is only one such number.</p>`, isCorrect: true },
            { label: `<p>There are only two such numbers.</p>`, isCorrect: false },
            { label: `<p>There can be more than one such number.</p>`, isCorrect: false },
            { label: `<p>No such number exists.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the central idea conveyed by the passage?</strong></p>`,
        options: [
            { label: `<p>Moving to net-zero carbon is possible only by the reduction in household emissions.</p>`, isCorrect: false },
            { label: `<p>Low-carbon behaviour in people can be brought about by incentivising them.</p>`, isCorrect: true },
            { label: `<p>Cheaper goods and services can be made available to people by using low-carbon technologies.</p>`, isCorrect: false },
            { label: `<p>Manufacturing industries that use low-carbon technologies should be provided with subsidies.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the most logical, rational and pragmatic message conveyed by the passage?</strong></p>`,
        options: [
            { label: `<p>Green economy is not possible without reusing critical minerals.</p>`, isCorrect: false },
            { label: `<p>Every sector of economy should adapt the reuse of material immediately.</p>`, isCorrect: false },
            { label: `<p>Circular economy can be beneficial for sustainable growth.</p>`, isCorrect: true },
            { label: `<p>Circular use of material resources is the only option for some industries for their survival.</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the above assumptions is/are valid?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: `<p>8 minutes</p>`, isCorrect: false },
            { label: `<p>10 minutes</p>`, isCorrect: false },
            { label: `<p>12 minutes</p>`, isCorrect: true },
            { label: `<p>16 minutes</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>0</p>`, isCorrect: false },
            { label: `<p>1</p>`, isCorrect: false },
            { label: `<p>2</p>`, isCorrect: true },
            { label: `<p>3</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>1</p>`, isCorrect: false },
            { label: `<p>13</p>`, isCorrect: false },
            { label: `<p>37</p>`, isCorrect: true },
            { label: `<p>481</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Who stole the mobile phone?</p>`,
        options: [
            { label: `<p>P</p>`, isCorrect: true },
            { label: `<p>Q</p>`, isCorrect: false },
            { label: `<p>R</p>`, isCorrect: false },
            { label: `<p>Cannot be concluded</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements best reflects the critical message conveyed by the author of the passage?</strong></p>`,
        options: [
            { label: "<p>Corporate capitalism is important for economic growth of a State and also for democracy.</p>", isCorrect: true },
            { label: "<p>Corporate capitalism is imperative for a modern State to achieve its political objectives.</p>", isCorrect: false },
            { label: "<p>No State can ensure its economic survival for long without the role of corporate capitalism.</p>", isCorrect: false },
            { label: "<p>Corporate capitalism and democracy have mutual dependence for their continued existence.</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p><strong>Which one of the following statements reflects the best explanation of the above passage?</strong></p>`,
        options: [
            { label: "<p>It emphasizes the inability of the State to enforce its will in practice against the opposition of certain groups within it.</p>", isCorrect: false },
            { label: "<p>It is a cooperative organization for the promotion of the well-being and development of the personality of its members.</p>", isCorrect: false },
            { label: "<p>It takes individuals out of a state of isolation and gives them a chance to participate in the common endeavour.</p>", isCorrect: true },
            { label: "<p>It permits citizens to have a variety of loyalties and allegiance.</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which of the statements given above is/are correct?</p>`,
    ...
    },
    {
        ...
        options: [
            { label: "<p>20 km</p>", isCorrect: false },
            { label: "<p>25 km</p>", isCorrect: false },
            { label: "<p>31 km</p>", isCorrect: true },
            { label: "<p>37 km</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: "<p>1000</p>", isCorrect: false },
            { label: "<p>1331</p>", isCorrect: true },
            { label: "<p>1728</p>", isCorrect: false },
            { label: "<p>2197</p>", isCorrect: false },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct in respect of the above Question and the Statements?</p>`,
        options: [
            ...
            { label: "<p>The Question can be answered by using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question can be answered by using both the Statements together, but cannot be answered using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question can be answered even without using any of the Statements.</p>", isCorrect: true },
        ],
        solution: "",
    },
    {
...
<p>Which one of the following is correct in respect of the above Question and the Statements?</p>`,
        options: [
            { label: "<p>The Question can be answered by using one of the Statements alone, but cannot be answered using the other statement alone.</p>", isCorrect: true },
            { label: "<p>The Question can be answered by using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question can be answered by using both the Statements together, but cannot be answered using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question can be answered even without using any of the Statements.</p>", isCorrect: false },
        ],
...
<p>Which one of the following is correct in respect of the above Question and the Statements?</p>`,
        options: [
            ...
            { label: "<p>The Question can be answered by using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question can be answered by using both the Statements together, but cannot be answered using either Statement alone.</p>", isCorrect: false },
            { label: "<p>The Question cannot be answered even using any of the Statements.</p>", isCorrect: true },
        ],
        solution: "",
    },
]
...
export const questionsSSCCGL1: Question[] = [
    {
        ...
        options: [
            { label: `<p>ZNBJGMF</p>`, isCorrect: true },
            { label: `<p>ZNBJFMG</p>`, isCorrect: false },
            { label: `<p>ZNBGFMJ</p>`, isCorrect: false },
            { label: `<p>ZNBFJMG</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
    ...
    },
    {
        ...
        options: [
            { label: `<p>40</p>`, isCorrect: false },
            { label: `<p>42</p>`, isCorrect: true },
            { label: `<p>44</p>`, isCorrect: false },
            { label: `<p>46</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Triangle</p>`, isCorrect: false },
            { label: `<p>Square</p>`, isCorrect: false },
            { label: `<p>Rectangle</p>`, isCorrect: false },
            { label: `<p>Circle</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>EDRIRL</p>`, isCorrect: false },
            { label: `<p>ECQOKF</p>`, isCorrect: true },
            { label: `<p>ECRPKF</p>`, isCorrect: false },
            { label: `<p>ECOQKF</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>EPH</p>`, isCorrect: true },
            { label: `<p>EPI</p>`, isCorrect: false },
            { label: `<p>FQH</p>`, isCorrect: false },
            { label: `<p>FPI</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>84</p>`, isCorrect: false },
            { label: `<p>100</p>`, isCorrect: false },
            { label: `<p>112</p>`, isCorrect: true },
            { label: `<p>120</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Apple</p>`, isCorrect: false },
            { label: `<p>Banana</p>`, isCorrect: false },
            { label: `<p>Orange</p>`, isCorrect: false },
            { label: `<p>Potato</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>XBUJI</p>`, isCorrect: true },
            { label: `<p>XBVJI</p>`, isCorrect: false },
            { label: `<p>XBUKI</p>`, isCorrect: false },
            { label: `<p>XAUJI</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>S</p>`, isCorrect: true },
            { label: `<p>T</p>`, isCorrect: false },
            { label: `<p>U</p>`, isCorrect: false },
            { label: `<p>V</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>1124</p>`, isCorrect: false },
            { label: `<p>1156</p>`, isCorrect: true },
            { label: `<p>1189</p>`, isCorrect: false },
            { label: `<p>1196</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Son</p>`, isCorrect: true },
            { label: `<p>Brother</p>`, isCorrect: false },
            { label: `<p>Nephew</p>`, isCorrect: false },
            { label: `<p>Cousin</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>26</p>`, isCorrect: false },
            { label: `<p>22</p>`, isCorrect: false },
            { label: `<p>24</p>`, isCorrect: true },
            { label: `<p>23</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>36</p>`, isCorrect: true },
            { label: `<p>30</p>`, isCorrect: false },
            { label: `<p>40</p>`, isCorrect: false },
            { label: `<p>49</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Pen</p>`, isCorrect: false },
            { label: `<p>Pencil</p>`, isCorrect: false },
            { label: `<p>Eraser</p>`, isCorrect: false },
            { label: `<p>Book</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>30</p>`, isCorrect: true },
            { label: `<p>31</p>`, isCorrect: false },
            { label: `<p>32</p>`, isCorrect: false },
            { label: `<p>33</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
    ...
    },
    {
        ...
        options: [
            { label: `<p>NVOJCB</p>`, isCorrect: true },
            { label: `<p>NVOJBD</p>`, isCorrect: false },
            { label: `<p>MVOJCB</p>`, isCorrect: false },
            { label: `<p>NUPJCB</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Car</p>`, isCorrect: false },
            { label: `<p>Bus</p>`, isCorrect: false },
            { label: `<p>Train</p>`, isCorrect: false },
            { label: `<p>Road</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>2</p>`, isCorrect: false },
            { label: `<p>4</p>`, isCorrect: false },
            { label: `<p>16</p>`, isCorrect: false },
            { label: `<p>34</p>`, isCorrect: true },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>UJHFS</p>`, isCorrect: true },
            { label: `<p>UJHFR</p>`, isCorrect: false },
            { label: `<p>UJIGS</p>`, isCorrect: false },
            { label: `<p>UJHGS</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>121</p>`, isCorrect: false },
            { label: `<p>243</p>`, isCorrect: true },
            { label: `<p>225</p>`, isCorrect: false },
            { label: `<p>256</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
    ...
    },
    {
        ...
        options: [
            { label: `<p>45</p>`, isCorrect: true },
            { label: `<p>46</p>`, isCorrect: false },
            { label: `<p>47</p>`, isCorrect: false },
            { label: `<p>50</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Paris</p>`, isCorrect: false },
            { label: `<p>London</p>`, isCorrect: false },
            { label: `<p>Tokyo</p>`, isCorrect: false },
            { label: `<p>River</p>`, isCorrect: true },
        ],
        solution: "",
    },
];
...
const questionsSSCCGL2: Question[] = [
    {
        id: 26,
        question: `<p>Who is known as the 'Father of the Indian Constitution'?</p>`,
        options: [
            { label: `<p>Mahatma Gandhi</p>`, isCorrect: false },
            { label: `<p>Dr. B.R. Ambedkar</p>`, isCorrect: true },
            { label: `<p>Jawaharlal Nehru</p>`, isCorrect: false },
            { label: `<p>Sardar Patel</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Venus</p>`, isCorrect: false },
            { label: `<p>Jupiter</p>`, isCorrect: false },
            { label: `<p>Mars</p>`, isCorrect: true },
            { label: `<p>Saturn</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        id: 28,
        question: `<p>The currency of Japan is:</p>`,
        options: [
            { label: `<p>Yuan</p>`, isCorrect: false },
            { label: `<p>Won</p>`, isCorrect: false },
            { label: `<p>Yen</p>`, isCorrect: true },
            { label: `<p>Ringgit</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        id: 29,
        question: `<p>Which is the longest river in the world?</p>`,
        options: [
            { label: `<p>Amazon</p>`, isCorrect: false },
            { label: `<p>Nile</p>`, isCorrect: true },
            { label: `<p>Ganges</p>`, isCorrect: false },
            { label: `<p>Mississippi</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        id: 30,
        question: `<p>The headquarters of UNESCO is located in:</p>`,
        options: [
            { label: `<p>New York</p>`, isCorrect: false },
            { label: `<p>Geneva</p>`, isCorrect: false },
            { label: `<p>Paris</p>`, isCorrect: true },
            { label: `<p>London</p>`, isCorrect: false },
        ],
        solution: "",
    },
...
const questionsSSCCGL3: Question[] = [
    {
        ...
        options: [
            { label: `<p>35</p>`, isCorrect: false },
            { label: `<p>38</p>`, isCorrect: false },
            { label: `<p>40</p>`, isCorrect: true },
            { label: `<p>42</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>7 cm</p>`, isCorrect: true },
            { label: `<p>14 cm</p>`, isCorrect: false },
            { label: `<p>21 cm</p>`, isCorrect: false },
            { label: `<p>28 cm</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>80</p>`, isCorrect: true },
            { label: `<p>85</p>`, isCorrect: false },
            { label: `<p>90</p>`, isCorrect: false },
            { label: `<p>95</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>₹50</p>`, isCorrect: false },
            { label: `<p>₹100</p>`, isCorrect: true },
            { label: `<p>₹150</p>`, isCorrect: false },
            { label: `<p>₹200</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
...
const questionsSSCCGL4: Question[] = [
    {
        ...
        options: [
            { label: `<p>Scarce</p>`, isCorrect: false },
            { label: `<p>Plentiful</p>`, isCorrect: true },
            { label: `<p>Limited</p>`, isCorrect: false },
            { label: `<p>Rare</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>He don't like coffee</p>`, isCorrect: false },
            { label: `<p>He doesn't likes coffee</p>`, isCorrect: false },
            { label: `<p>He doesn't like coffee</p>`, isCorrect: true },
            { label: `<p>He not like coffee</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Hopeful</p>`, isCorrect: false },
            { label: `<p>Positive</p>`, isCorrect: false },
            { label: `<p>Pessimistic</p>`, isCorrect: true },
            { label: `<p>Confident</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>postponed</p>`, isCorrect: true },
            { label: `<p>preponed</p>`, isCorrect: false },
            { label: `<p>advanced</p>`, isCorrect: false },
            { label: `<p>delayed</p>`, isCorrect: false },
        ],
        solution: "",
    },
    {
        ...
        options: [
            { label: `<p>Occassion</p>`, isCorrect: false },
            { label: `<p>Occasion</p>`, isCorrect: true },
            { label: `<p>Ocasion</p>`, isCorrect: false },
            { label: `<p>Occassion</p>`, isCorrect: false },
        ],
        solution: "",
    },
