...
export default function QuestionBankListScreen() {
                ...
                <div className="my-5">
                    ...
                    <div className="border border-[#eee] mb-5">
                        ...
                        <div className="p-6 space-y-4 text-sm">
                            ...
                            {/* Name */}
                            <div className="flex items-center space-x-4">
                                <label className="w-40 font-medium text-gray-700">Question Bank Name :</label>
                                <input
                                    type="text"
                                    name="testName"
                                    value={form.name}
    ...
    ${question?.difficulty === "easy"
                                            ...
                                            <div
                                                className="text-base leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:my-1"
